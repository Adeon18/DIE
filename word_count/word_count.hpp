...
namespace word_count {
    ...
    void write_sorted_map_to_file(mt_unordered_map::mt_unordered_map_t<std::string, size_t>& global_map, std::function<bool(std::pair<std::string, size_t> & word1, std::pair<std::string, size_t> & word2)> f, const std::string & file_path);
